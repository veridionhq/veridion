...
- The first contextual scoring hooks are policy-controlled and opt-in. Default policy leaves the base RDI model unchanged, including AI-origin, runtime, deployment-window, ownership, and trust-baseline penalties unless explicitly configured.
