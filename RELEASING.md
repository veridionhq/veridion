...
3. create and push the `v1.0.2` tag
...
- prefer `uses: veridionhq/veridion@v1.0.2` in external workflows
- prefer `git+https://github.com/veridionhq/veridion.git@v1.0.2` for documented install examples
